(function() {
    ...
    openLists = (product) => {
        ...
        $('#sale-body').append(
            `<tr class="rows" id="row${product.id}">
                ...
                <td class="qty-row">
                    ...
                    <div id="inc" class="inc button${product.id}">+</div>
                </td>
                <td><input id="sub${product.id}" class="sub" type="text" readonly value="₦${parseFloat(subtotal).toFixed(2)}" /></td>
                <td>
        ...
        $("#svg" + product.id).on("click", function() {
            var tr = document.getElementById("row" + product.id);
